...
<head>
    ...
    <meta name="description"
        content="Arabic Learning Course - Semester 2 page of the Islamic website Maktaba tul Ahadith">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Arabic Course Semester 2 - مكتبة الأحاديث</title>
        ...
        <main>
            <div class="main">
                <article class="container container-major">
                    ...
                    <h2 class="langDiv langDiv-en">Semester 2</h2>
                    <h2 class="langDiv langDiv-ur urdu-text hide-imp">سمیسٹر 2</h2>
                    <img src="<?php echo BASE_URL ?>images/arabic-course-background.png" alt="Arabic Course Icon"
                        height="600" width="600" title="Arabic Course Section">
                </article>

                <article class="container container-without-pad-bg">
                    <a href="<?php echo BASE_URL ?>download.php?file=pdfs/Semester-2-Syllabus.pdf"
                        class="button-type-1 hover-effect button-download"
                        aria-label="Button link to start semester 2 course material download">
                ...
                <article class="container arabic-course-semester">
                    ...
                    <details class="accordion ">
                        ...
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 2 Lecture 1"
                    ...
                    <details class="accordion">
                        ...
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 2 Lecture 2"
                                    src="https://www.youtube.com/embed/OxSyzfwfUos?si=zSHGcykAjL7GiK4T" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    ...
                    <details class="accordion">
                        ...
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 2 Lecture 3"
                                    src="https://www.youtube.com/embed/OxSyzfwfUos?si=zSHGcykAjL7GiK4T" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
