...
<head>
    ...
    <meta name="description"
        content="Arabic Learning Course - Semester 1 page of the Islamic website Maktaba tul Ahadith">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Arabic Course Semester 1 - مكتبة الأحاديث</title>
        ...
        <main>
            <div class="main">
                <article class="container container-major">
                    ...
                    <h2 class="langDiv langDiv-en">Semester 1</h2>
                    <h2 class="langDiv langDiv-ur urdu-text hide-imp">سمیسٹر 1</h2>
                    <img src="<?php echo BASE_URL ?>images/arabic-course-background.png" alt="Arabic Course Icon"
                        height="600" width="600" title="Arabic Course Section">
                </article>

                <article class="container container-without-pad-bg">
                    <a href="<?php echo BASE_URL ?>download.php?file=pdfs/Semester-1-Syllabus.pdf"
                        class="button-type-1 hover-effect button-download"
                        aria-label="Button link to start semester 1 course material download">
                ...
                <article class="container arabic-course-semester">
                    ...
                    <details class="accordion ">
                        ...
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 1 Lecture 1"
                    ...
                    <details class="accordion">
                        ...
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 1 Lecture 2"
                                    src="https://www.youtube.com/embed/OxSyzfwfUos?si=zSHGcykAjL7GiK4T" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    ...
                    <details class="accordion">
                        ...
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 1 Lecture 3"
                                    src="https://www.youtube.com/embed/OxSyzfwfUos?si=zSHGcykAjL7GiK4T" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    ...
                    <details class="accordion">
                        <summary class="accordion__heading">
                            <span class="langDiv langDiv-en fontDiv fontDiv-m">Lecture 4</span>
                            <span class="langDiv langDiv-ur urdu-text hide-imp line-height-1 fontDiv fontDiv-ml">لیکچر
                                4</span>
                        </summary>
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 1 Lecture 4"
                                    src="https://www.youtube.com/embed/OxSyzfwfUos?si=zSHGcykAjL7GiK4T" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    ...
                    <details class="accordion">
                        <summary class="accordion__heading">
                            <span class="langDiv langDiv-en fontDiv fontDiv-m">Lecture 5</span>
                            <span class="langDiv langDiv-ur urdu-text hide-imp line-height-1 fontDiv fontDiv-ml">لیکچر
                                5</span>
                        </summary>
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 1 Lecture 5"
                                    src="https://www.youtube.com/embed/OxSyzfwfUos?si=zSHGcykAjL7GiK4T" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    ...
                    <details class="accordion">
                        <summary class="accordion__heading">
                            <span class="langDiv langDiv-en fontDiv fontDiv-m">Lecture 6</span>
                            <span class="langDiv langDiv-ur urdu-text hide-imp line-height-1 fontDiv fontDiv-ml">لیکچر
                                6</span>
                        </summary>
                        <div class="accordion__content">
                            <div class="video-wrapper">
                                <iframe width="850" height="480" title="Semester 1 Lecture 6"
                                    src="https://www.youtube.com/embed/OxSyzfwfUos?si=zSHGcykAjL7GiK4T" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
